...
[`@aws-sdk/client-ssm-contacts`](https://www.npmjs.com/package/@aws-sdk/client-ssm-contacts/v/3.882.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-contacts@3.882.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TX479Pvtsph9sIz/bzlmi9lE308EC//+BFPnVNoY9o40+OwE977LVWOVPkMREcNK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-contacts": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-contacts@3.882.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-contacts@3.882.0/index.min.mjs": "sha384-TX479Pvtsph9sIz/bzlmi9lE308EC//+BFPnVNoY9o40+OwE977LVWOVPkMREcNK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-contacts/blob/refs/tags/3.882.0/LICENSE
```
