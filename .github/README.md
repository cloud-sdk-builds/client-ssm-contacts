...
[`@aws-sdk/client-ssm-contacts`](https://www.npmjs.com/package/@aws-sdk/client-ssm-contacts/v/3.956.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-contacts@3.956.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zbYmem8SLd/fayJfO3E9fzx6lVO6NpDuSumwoIP3yTFSyzGCW1FRirfbMcizeCD0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-contacts": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-contacts@3.956.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-contacts@3.956.0/index.min.mjs": "sha384-zbYmem8SLd/fayJfO3E9fzx6lVO6NpDuSumwoIP3yTFSyzGCW1FRirfbMcizeCD0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-contacts/blob/refs/tags/3.956.0/LICENSE
```
